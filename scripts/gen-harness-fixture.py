"""Generate harness fixture: signed POST body for /v2/harnesses/register."""
...
signed_fields = {
    "name": "opencastor-vla-v1",
    "version": "2026.4.0",
    "harness_type": "vla",
    "rcan_version": "3.0",
    "description": "Vision-language-action harness for OpenCastor runtime.",
    "open_source": True,
